    ...
    return (
        <div className="bg-[#121220] relative  ">
           ...
           <div className="flex justify-center items-center absolute -top-[30%] w-full">
                <div className="border-2 hover:border-[#abc54b] bg-[#ffffff] text-white bg-cover bg-center w-1/2 py-16 px-10 rounded-2xl" 
                style={{
            ...
            <div className="mx-auto max-w-screen-xl md:pt-28 pt-10 pb-10  w-full  px-2 text-white grid grid-cols-2 md:grid-cols-4 gap-10  md:gap-6">
                <div>
                ...
                <div>
                    ...
                    <p className="mb-4">
                        Phone:
                        01911454000 <br /> Email: help@hla.com
                    </p>
                    <div>
                        <img
                            className="md:w-3/5"
